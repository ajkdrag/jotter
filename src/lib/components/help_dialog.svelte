<script lang="ts">
  ...
  import { EDITOR_SHORTCUTS, MARKDOWN_SYNTAX } from "$lib/domain/help_data";
  import { format_hotkey_for_display } from "$lib/domain/hotkey_validation";
  import type { HotkeyConfig, HotkeyCategory } from "$lib/types/hotkey_config";
