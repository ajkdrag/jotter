...
async function execute_command(input: ActionRegistrationInput, command_id: CommandId) {
...
export function register_omnibar_actions(input: ActionRegistrationInput) {
  ...
  registry.register({
    ...
    execute: async (query: unknown) => {
      ...
      stores.ui.omnibar = { ...stores.ui.omnibar, query: normalized_query, selected_index: 0 }
  ...
  registry.register({
    ...
    execute: (index: unknown) => {
      stores.ui.omnibar = { ...stores.ui.omnibar, selected_index: Number(index) }
    }
  })
