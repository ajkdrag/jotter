...
import { looks_like_markdown, pick_paste_mode } from '$lib/adapters/editor/markdown_paste_utils'
...
describe('looks_like_markdown', () => {
  ...
  it('detects links and images', () => {
    ...
    expect(looks_like_markdown('![alt](https://example.com/img.png)')).toBe(true)
  })
  ...
  it('does not match plain text', () => {
    expect(looks_like_markdown('Just a sentence with no markdown.')).toBe(false)
  })
})
